...
T_steps = 4  # the number of different temperatures we want to hit inbetween the initial and final temperature
...
# for the ith monte carlo step we will use the ith time from the T_array
